...
export const FooterLeft = () => {
  ...
  return (
    <div>
      <h4 className="text-[#000000B2] text-xl font-bold mb-[21px]">
        {t("follow-us")}
      </h4>
      ...
      <h4 className="text-[#000000B2] text-xl font-bold mt-[39px] mb-[12px]">
        {t("download-app")}
      </h4>
      <div className="flex items-start gap-[10px]">
        <button className="py-[17px] px-[30px] flex items-center gap-[12px] rounded-[6px] bg-[#EBEFF3] text-base font-bold">
          <AppStoreIcon />
          App Store
        </button>
        <button className="py-[17px] px-[30px] flex items-center gap-[12px] rounded-[6px] bg-[#EBEFF3] text-base font-bold">
